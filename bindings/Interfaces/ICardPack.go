...
var ICardPackMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"tokenId\",\"type\":\"uint256\"}],\"name\":\"changeToOpened\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"tokenId\",\"type\":\"uint256\"}],\"name\":\"isOpened\",\"outputs\":[{\"internalType\":\"bool\",\"name\":\"\",\"type\":\"bool\"}],\"stateMutability\":\"view\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"address\",\"name\":\"_to\",\"type\":\"address\"},{\"internalType\":\"uint256\",\"name\":\"_quantity\",\"type\":\"uint256\"},{\"internalType\":\"uint256\",\"name\":\"_tier\",\"type\":\"uint256\"},{\"internalType\":\"string\",\"name\":\"_tokenURI\",\"type\":\"string\"}],\"name\":\"mint\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"},{\"inputs\":[{\"internalType\":\"uint256\",\"name\":\"tokenId\",\"type\":\"uint256\"}],\"name\":\"ownerOf\",\"outputs\":[{\"internalType\":\"address\",\"name\":\"\",\"type\":\"address\"}],\"stateMutability\":\"view\",\"type\":\"function\"}]",
}
...
//
// Solidity: function mint(address _to, uint256 _quantity, uint256 _tier, string _tokenURI) returns(uint256)
func (_ICardPack *ICardPackTransactor) Mint(opts *bind.TransactOpts, _to common.Address, _quantity *big.Int, _tier *big.Int, _tokenURI string) (*types.Transaction, error) {
	return _ICardPack.contract.Transact(opts, "mint", _to, _quantity, _tier, _tokenURI)
}

// Mint is a paid mutator transaction binding the contract method 0xbb7fde71.
//
// Solidity: function mint(address _to, uint256 _quantity, uint256 _tier, string _tokenURI) returns(uint256)
func (_ICardPack *ICardPackSession) Mint(_to common.Address, _quantity *big.Int, _tier *big.Int, _tokenURI string) (*types.Transaction, error) {
	return _ICardPack.Contract.Mint(&_ICardPack.TransactOpts, _to, _quantity, _tier, _tokenURI)
}

// Mint is a paid mutator transaction binding the contract method 0xbb7fde71.
//
// Solidity: function mint(address _to, uint256 _quantity, uint256 _tier, string _tokenURI) returns(uint256)
func (_ICardPack *ICardPackTransactorSession) Mint(_to common.Address, _quantity *big.Int, _tier *big.Int, _tokenURI string) (*types.Transaction, error) {
	return _ICardPack.Contract.Mint(&_ICardPack.TransactOpts, _to, _quantity, _tier, _tokenURI)
}
