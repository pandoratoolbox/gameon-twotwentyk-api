...
var ICategoryMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"string\",\"name\":\"_tokenURI\",\"type\":\"string\"},{\"internalType\":\"address\",\"name\":\"_owner\",\"type\":\"address\"}],\"name\":\"mintCategory\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
//
// Solidity: function mintCategory(string _tokenURI, address _owner) returns()
func (_ICategory *ICategoryTransactor) MintCategory(opts *bind.TransactOpts, _tokenURI string, _owner common.Address) (*types.Transaction, error) {
	return _ICategory.contract.Transact(opts, "mintCategory", _tokenURI, _owner)
}

// MintCategory is a paid mutator transaction binding the contract method 0xa25e3bd3.
//
// Solidity: function mintCategory(string _tokenURI, address _owner) returns()
func (_ICategory *ICategorySession) MintCategory(_tokenURI string, _owner common.Address) (*types.Transaction, error) {
	return _ICategory.Contract.MintCategory(&_ICategory.TransactOpts, _tokenURI, _owner)
}

// MintCategory is a paid mutator transaction binding the contract method 0xa25e3bd3.
//
// Solidity: function mintCategory(string _tokenURI, address _owner) returns()
func (_ICategory *ICategoryTransactorSession) MintCategory(_tokenURI string, _owner common.Address) (*types.Transaction, error) {
	return _ICategory.Contract.MintCategory(&_ICategory.TransactOpts, _tokenURI, _owner)
}
