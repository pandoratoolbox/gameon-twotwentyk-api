...
var IDayMonthMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"string\",\"name\":\"_tokenURI\",\"type\":\"string\"},{\"internalType\":\"address\",\"name\":\"_owner\",\"type\":\"address\"}],\"name\":\"mintDayMonth\",\"outputs\":[],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
//
// Solidity: function mintDayMonth(string _tokenURI, address _owner) returns()
func (_IDayMonth *IDayMonthTransactor) MintDayMonth(opts *bind.TransactOpts, _tokenURI string, _owner common.Address) (*types.Transaction, error) {
	return _IDayMonth.contract.Transact(opts, "mintDayMonth", _tokenURI, _owner)
}

// MintDayMonth is a paid mutator transaction binding the contract method 0xdfe2ead4.
//
// Solidity: function mintDayMonth(string _tokenURI, address _owner) returns()
func (_IDayMonth *IDayMonthSession) MintDayMonth(_tokenURI string, _owner common.Address) (*types.Transaction, error) {
	return _IDayMonth.Contract.MintDayMonth(&_IDayMonth.TransactOpts, _tokenURI, _owner)
}

// MintDayMonth is a paid mutator transaction binding the contract method 0xdfe2ead4.
//
// Solidity: function mintDayMonth(string _tokenURI, address _owner) returns()
func (_IDayMonth *IDayMonthTransactorSession) MintDayMonth(_tokenURI string, _owner common.Address) (*types.Transaction, error) {
	return _IDayMonth.Contract.MintDayMonth(&_IDayMonth.TransactOpts, _tokenURI, _owner)
}
