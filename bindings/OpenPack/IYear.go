...
var IYearMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"string\",\"name\":\"tokenURI\",\"type\":\"string\"},{\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"name\":\"createYear\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
// CreateYear is a paid mutator transaction binding the contract method 0xe9a7bf10.
//
// Solidity: function createYear(string tokenURI, address owner) returns(uint256)
func (_IYear *IYearTransactor) CreateYear(opts *bind.TransactOpts, tokenURI string, owner common.Address) (*types.Transaction, error) {
	return _IYear.contract.Transact(opts, "createYear", tokenURI, owner)
}

// CreateYear is a paid mutator transaction binding the contract method 0xe9a7bf10.
//
// Solidity: function createYear(string tokenURI, address owner) returns(uint256)
func (_IYear *IYearSession) CreateYear(tokenURI string, owner common.Address) (*types.Transaction, error) {
	return _IYear.Contract.CreateYear(&_IYear.TransactOpts, tokenURI, owner)
}

// CreateYear is a paid mutator transaction binding the contract method 0xe9a7bf10.
//
// Solidity: function createYear(string tokenURI, address owner) returns(uint256)
func (_IYear *IYearTransactorSession) CreateYear(tokenURI string, owner common.Address) (*types.Transaction, error) {
	return _IYear.Contract.CreateYear(&_IYear.TransactOpts, tokenURI, owner)
}
