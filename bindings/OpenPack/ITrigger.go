...
var ITriggerMetaData = &bind.MetaData{
	ABI: "[{\"inputs\":[{\"internalType\":\"string\",\"name\":\"tokenURI\",\"type\":\"string\"},{\"internalType\":\"address\",\"name\":\"owner\",\"type\":\"address\"}],\"name\":\"createTrigger\",\"outputs\":[{\"internalType\":\"uint256\",\"name\":\"\",\"type\":\"uint256\"}],\"stateMutability\":\"nonpayable\",\"type\":\"function\"}]",
}
...
// CreateTrigger is a paid mutator transaction binding the contract method 0x914ea280.
//
// Solidity: function createTrigger(string tokenURI, address owner) returns(uint256)
func (_ITrigger *ITriggerTransactor) CreateTrigger(opts *bind.TransactOpts, tokenURI string, owner common.Address) (*types.Transaction, error) {
	return _ITrigger.contract.Transact(opts, "createTrigger", tokenURI, owner)
}

// CreateTrigger is a paid mutator transaction binding the contract method 0x914ea280.
//
// Solidity: function createTrigger(string tokenURI, address owner) returns(uint256)
func (_ITrigger *ITriggerSession) CreateTrigger(tokenURI string, owner common.Address) (*types.Transaction, error) {
	return _ITrigger.Contract.CreateTrigger(&_ITrigger.TransactOpts, tokenURI, owner)
}

// CreateTrigger is a paid mutator transaction binding the contract method 0x914ea280.
//
// Solidity: function createTrigger(string tokenURI, address owner) returns(uint256)
func (_ITrigger *ITriggerTransactorSession) CreateTrigger(tokenURI string, owner common.Address) (*types.Transaction, error) {
	return _ITrigger.Contract.CreateTrigger(&_ITrigger.TransactOpts, tokenURI, owner)
}
