...
// CreateCollection is a paid mutator transaction binding the contract method 0x64d54151.
//
// Solidity: function createCollection(string _tokenURI, uint256 _totalAmount) payable returns(uint256, string)
func (_Collection *CollectionTransactor) CreateCollection(opts *bind.TransactOpts, _tokenURI string, _totalAmount *big.Int) (*types.Transaction, error) {
	return _Collection.contract.Transact(opts, "createCollection", _tokenURI, _totalAmount)
}

// CreateCollection is a paid mutator transaction binding the contract method 0x64d54151.
//
// Solidity: function createCollection(string _tokenURI, uint256 _totalAmount) payable returns(uint256, string)
func (_Collection *CollectionSession) CreateCollection(_tokenURI string, _totalAmount *big.Int) (*types.Transaction, error) {
	return _Collection.Contract.CreateCollection(&_Collection.TransactOpts, _tokenURI, _totalAmount)
}

// CreateCollection is a paid mutator transaction binding the contract method 0x64d54151.
//
// Solidity: function createCollection(string _tokenURI, uint256 _totalAmount) payable returns(uint256, string)
func (_Collection *CollectionTransactorSession) CreateCollection(_tokenURI string, _totalAmount *big.Int) (*types.Transaction, error) {
	return _Collection.Contract.CreateCollection(&_Collection.TransactOpts, _tokenURI, _totalAmount)
}
